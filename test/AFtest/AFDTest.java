...
public class AFDTest {
	...
	private static AFD automato1;
	private static String[] alfabeto = {"0", "1"};
	private static AFD automato2;
	private static AFD automato3;
	private static AFD automato4;

	@Test
	public void testSetUp() throws Exception {
		automato1 = new AFD(alfabeto);
		...
		Assertions.assertTrue(automato1.aceitaPalavra("0"));
	}
	@BeforeAll
	...
	@Test
	public void testAcceptWords () throws EntradaIndefinidaException {
	...
	public void testComparation () {
		Assert.assertEquals(automato1, automato1);
	}
