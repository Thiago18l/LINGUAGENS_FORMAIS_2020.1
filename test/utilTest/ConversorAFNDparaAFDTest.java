...
public class ConversorAFNDparaAFDTest {
	...
	public void setUp() throws Exception{
		...
		//(alfabeto 1,0) Aceita apenas palavras de tamanho �mpar:
		...
		q1.setFinal(true); //q1 = entrada de tamanho �mpar
		...
		r2.setFinal(true); //r2 = entrada de tamanho par e �ltimo lido foi 1
